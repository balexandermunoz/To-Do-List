...
function acceptTask() {
    ...
    let msg = currProject.addTask(new _tasks__WEBPACK_IMPORTED_MODULE_0__["default"](title,description,priority,date)) //Return error mesage or "Done!"
    p.textContent = msg;
...
class user {
    ...
    static createDefaultInstance(){
        ...
        const project1 = new _projects__WEBPACK_IMPORTED_MODULE_1__["default"]('General');
        const project2 = new _projects__WEBPACK_IMPORTED_MODULE_1__["default"]('Today');
        const project3 = new _projects__WEBPACK_IMPORTED_MODULE_1__["default"]('This week');
    ...
    static getUserData(keyUser){
        ...
        newUser.projects.forEach( (project,i) => {
            newUser.projects[i] = Object.assign(new _projects__WEBPACK_IMPORTED_MODULE_1__["default"](),project)
...
console.log(toggleLeftBtn)
console.log(left)

toggleLeftBtn.addEventListener('click', openMenu);
function openMenu(){
