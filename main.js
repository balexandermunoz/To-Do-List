...
let newUser;
if (_user__WEBPACK_IMPORTED_MODULE_2__["default"].storageAvailable('localStorage')) {
    console.log('Aviliable local storage!');
    newUser = _user__WEBPACK_IMPORTED_MODULE_2__["default"].checkStorage('User');
}
else {
    console.log('Your data will be deleted after close this page.')
    newUser = _user__WEBPACK_IMPORTED_MODULE_2__["default"].createDefaultInstance();
}
...
new sortablejs__WEBPACK_IMPORTED_MODULE_3__["default"](ul,{
    animation: 200,
    ghostClass:'ghost',
...
new sortablejs__WEBPACK_IMPORTED_MODULE_3__["default"](projectsDiv,{
    group: 'projects',
    animation: 200,
    ghostClass:'ghost',
    onEnd: function(event){
...
function showProjects(projectsList) {
    ...
    for(let i = 0; i< projectsList.length;i++){
        ...
        _user__WEBPACK_IMPORTED_MODULE_2__["default"].setUserData( 'User', newUser );
    }
}
...
function acceptProject(){
    ...
    let msg = newUser.addProject(new _projects__WEBPACK_IMPORTED_MODULE_1__["default"](name)); //Return error mesage or "Done!"
...
function acceptTask() {
    ...
    let addingTask = new _tasks__WEBPACK_IMPORTED_MODULE_0__["default"](title,description,priority,date)
...
class Task {
    ...
    todayTask(){ //Not work
        let date = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(new Date(this.date))
