...
const date = new Date();
const currentDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(date, 'yyyy-MM-dd');

// Storage things:
// localStorage.clear() //Clean the local storage
let newUser;
if (_user__WEBPACK_IMPORTED_MODULE_3__["default"].storageAvailable('localStorage')) {
  console.log('Aviliable local storage!');
  newUser = _user__WEBPACK_IMPORTED_MODULE_3__["default"].checkStorage('User');
} else {
  console.log('Your data will be deleted after close this page.');
  newUser = _user__WEBPACK_IMPORTED_MODULE_3__["default"].createDefaultInstance();
}
...
const sortableProjects = new sortablejs__WEBPACK_IMPORTED_MODULE_0__["default"](ul, {
  animation: 200,
  ghostClass: 'ghost',
  onEnd(event) {
...
const sortableTasks = new sortablejs__WEBPACK_IMPORTED_MODULE_0__["default"](projectsDiv, {
  group: 'projects',
  animation: 200,
  ghostClass: 'ghost',
  onEnd(event) {
...
function showProjects(projectsList) {
  ...
  for (let i = 0; i < projectsList.length; i++) {
    ...
    _user__WEBPACK_IMPORTED_MODULE_3__["default"].setUserData('User', newUser);
  }
}
...
function acceptProject() {
  ...
  const msg = newUser.addProject(new _projects__WEBPACK_IMPORTED_MODULE_2__["default"](name));
...
function displayAddTask(e,curTitle = '', curDescription = '', currPriority = 'none', currDate = 'none', idx='none') {
  ...
  function acceptTask(idx='none') {
    ...
    const addingTask = new _tasks__WEBPACK_IMPORTED_MODULE_1__["default"](title.value, description.value, checkedRadioBtn.value, date.value);
...
class Project {
  ...
  getTodayTasks() {
    return this.tasks.filter((task) => {
      ...
      return (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(toDate(taskDate));
    });
  }
  ...
  getWeekTasks() {
    return this.tasks.filter((task) => {
      const taskDate = new Date(task.getDateFormatted());
      return (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(subDays(toDate(taskDate), 1));
    });
  }
}
...
class Task {
  ...
  todayTask() { // Not work
    const date = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(new Date(this.date));
...
class user {
  ...
  static createDefaultInstance() {
    ...
    const date = new Date();
    const currentDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(date, 'yyyy-MM-dd');
    const treeDays = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(date.addDays(3), 'yyyy-MM-dd');
    const fiveDays = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(date.addDays(5), 'yyyy-MM-dd');

    const newUser = new user();
    const project1 = new _projects__WEBPACK_IMPORTED_MODULE_1__["default"]('General', true);
    const project2 = new _projects__WEBPACK_IMPORTED_MODULE_1__["default"]('Today', true);
    const project3 = new _projects__WEBPACK_IMPORTED_MODULE_1__["default"]('This week', true);
    const myProject = new _projects__WEBPACK_IMPORTED_MODULE_1__["default"]('My project');

    const task1 = new _tasks__WEBPACK_IMPORTED_MODULE_0__["default"]('Example task 0', 'This is a example task', 'Normal', currentDate);
    const task2 = new _tasks__WEBPACK_IMPORTED_MODULE_0__["default"]('Example task 1', 'This is a example task', 'Important', treeDays);
    const task3 = new _tasks__WEBPACK_IMPORTED_MODULE_0__["default"]('Example task 2', 'This is a example task', 'Urgent', fiveDays);
  ...
  static reasignProjectClass(projectsList) {
    projectsList.forEach((project, i) => {
      projectsList[i] = Object.assign(new _projects__WEBPACK_IMPORTED_MODULE_1__["default"](), project);
      project.tasksArray.forEach((task, j) => {
        project.tasksArray[j] = Object.assign(new _tasks__WEBPACK_IMPORTED_MODULE_0__["default"](), task);
      });
    });
  }
...
addProjectButton.addEventListener('click', _dom__WEBPACK_IMPORTED_MODULE_0__.displayAddProject);

addTodoButton.addEventListener('click', _dom__WEBPACK_IMPORTED_MODULE_0__.displayAddTask);
